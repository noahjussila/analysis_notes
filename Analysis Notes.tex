...
If these notes are ever finished (which is unlikely), they will span about four semesters worth of real analysis: two at an honors undergraduate level, and two at a introductory PhD level. The following table gives a brief overview of the topics, and what sources I'm pulling from for each part:
...
\end{proof}
\begin{remark}
	Part 1 of Theorem 3.2  allow us immediately to perform subtraction using limits. Parts 3 and 4 allow us to do the same with division. 
\end{remark}
...
\begin{figure}[h!]
	...
	\draw (6,-0.3) node {$ x_0$};
	\draw (5,-0.3) node {$ x_0-\delta/2$};
	\draw (7,-0.3) node {$ x_0+\delta/2$};
	\draw[blue] (10,8.3) node {$ f(x)$};
	\draw (-0.9,5.35) node {$ L-\varepsilon/2$};
	\draw (-0.9,6.55) node {$ L+\varepsilon/2$};
	\draw (-0.8,6) node {$ L$};
	\end{tikzpicture}
...
\begin{figure}[h!]
	...
	\draw (-0.9,5.35) node {$ f(x_0)-\varepsilon/2$};
	\draw (-0.9,6.55) node {$ f(x_0)+\varepsilon/2$};
...
\begin{figure}[h!]
	...
	\draw[black] (13.3,2.48) node {$ \varepsilon$};
	\draw[black] (14,1.38) node {$ \delta$};
	\end{tikzpicture}
...
\end{definition}
Both of these definitions can be cast in terms of $ \varepsilon $ and $ \delta $, but that is not quite necessary, as they only serve as a means to define various types of discontinuity. It also can be proven that if $ f(x+)=f(x-) $, then $ \lim_{x\to p}f(x)=p $. The first type of discontinuity is the type we saw in Figure 37. This type it special, as it does not prohibit the existence of a limit at a point.
\begin{definition}
...
\begin{figure}[h!]
	...
	\draw[thin, dashed] (0,6) -- (7.5,6);
	\draw[thin, dashed] (7.5,0) -- (7.5,6);
	\draw[thin, dashed] (4.7,0) -- (4.7,4);
	\draw[thin, dashed] (10.3,0) -- (10.3,4);
	\draw[thin, dashed] (0,3.92) -- (10.3,3.92);
	\draw[black] (-.7,6) node {$ f(x_0) $};
	\draw[black] (-1.4,4) node {$ f(x_1)=f(x_2) $};
	\draw[black] (7.5,-.5) node {$ x_0 $};
	\draw[black] (4.7,-.5) node {$ x_1 $};
	\draw[black] (10.3,-.5) node {$ x_2 $};
...
\begin{figure}[h!]
	...
	\draw[black] (-.6,6.01) node {$ f(a) $};
	\draw[black] (6,-.5) node {$ a $};
	\draw[blue] (12,5) node {$ f(x) $};	
	\filldraw[black] (6,6.01) circle (2pt);
	\draw[red] (8,7) node{$ f(a)+f'(a)(x-a) $};	
	\end{tikzpicture}
	\caption{. }
\end{figure}
...
\begin{figure}[h!]
	...
	\draw[black] (1,-.5) node {$ a $};
	\draw[black] (14,-.5) node {$ b $};	
	\draw[fill=gray!15, thick, opacity=0.6] (1,0) rectangle (2,1);
	\draw[fill=gray!15, thick, opacity=0.6] (2,0) rectangle (3,2.35);
	\draw[fill=gray!15, thick, opacity=0.6] (3,0) rectangle (4,3.5);
	\draw[fill=gray!15, thick, opacity=0.6] (4,0) rectangle (5,4.5);
	\draw[fill=gray!15, thick, opacity=0.6] (5,0) rectangle (6,5.25);
	\draw[fill=gray!15, thick, opacity=0.6] (6,0) rectangle (7,5.77);
	\draw[fill=gray!15, thick, opacity=0.6] (7,0) rectangle (8,5.69);
	\draw[fill=gray!15, thick, opacity=0.6] (8,0) rectangle (9,3.55);
	\draw[fill=gray!15, thick, opacity=0.6] (9,0) rectangle (10,1.2);
	\draw[fill=gray!15, thick, opacity=0.6] (10,0) rectangle (11,0.98);
	\draw[fill=gray!15, thick, opacity=0.6] (11,0) rectangle (12,1);
	\draw[fill=gray!15, thick, opacity=0.6] (12,0) rectangle (13,1.6);
	\draw[fill=gray!15, thick, opacity=0.6] (13,0) rectangle (14,2.9);
	\draw [blue, thick] plot [smooth, tension=1] coordinates { (1,1) (7,6) (10.5,1) (14,5) };
	\end{tikzpicture}
	\caption{  }
\end{figure}
\begin{figure}[h!]
	...
	\draw[black] (1,-.5) node {$ a $};
	\draw[black] (14,-.5) node {$ b $};	
	\draw[fill=gray!15, thick, opacity=0.6] (1,0) rectangle (2,2.35);
	\draw[fill=gray!15, thick, opacity=0.6] (2,0) rectangle (3,3.5);
	\draw[fill=gray!15, thick, opacity=0.6] (3,0) rectangle (4,4.5);
	\draw[fill=gray!15, thick, opacity=0.6] (4,0) rectangle (5,5.25);
	\draw[fill=gray!15, thick, opacity=0.6] (5,0) rectangle (6,5.77);
	\draw[fill=gray!15, thick, opacity=0.6] (6,0) rectangle (7,6);
	\draw[fill=gray!15, thick, opacity=0.6] (7,0) rectangle (8,6);
	\draw[fill=gray!15, thick, opacity=0.6] (8,0) rectangle (9,5.6);
	\draw[fill=gray!15, thick, opacity=0.6] (9,0) rectangle (10,3.55);
	\draw[fill=gray!15, thick, opacity=0.6] (10,0) rectangle (11,1.2);
	\draw[fill=gray!15, thick, opacity=0.6] (11,0) rectangle (12,1.6);
	\draw[fill=gray!15, thick, opacity=0.6] (12,0) rectangle (13,2.9);
	\draw[fill=gray!15, thick, opacity=0.6] (13,0) rectangle (14,5);
	\draw [blue, thick] plot [smooth, tension=1] coordinates { (1,1) (7,6) (10.5,1) (14,5) };
	\end{tikzpicture}
	\caption{  }
\end{figure}
...
\begin{figure}[h!]
	...
	\draw[dashed] (0.5,-0.5)  to[out=90,in=180]  (7.5,4);
	\draw[dashed] (7.5,4) to[out=0,in=270] (15.5, 8.5) ;
	\filldraw[white] (-0.52,0.5) rectangle (-0.01,5);
	\filldraw[white] (0,-0.52) rectangle (5,-0.01);
...
\end{figure}
	...
	\draw[thick,->] (7.6,3) -- (14.4,3);
	\draw[thick,->] (11,-0.4) -- (11,6.4);
	\draw [thick, red] (6.5,0) -- (11,6);
	\draw [thick, red] (6.95,0) -- (11.45,6);
	\draw [thick, red] (7.4,0) -- (11.9,6);
	\draw [thick, red] (7.85,0) -- (12.35,6);
	\draw [thick, red] (8.3,0) -- (12.8,6); 
	\draw [thick, red] (8.75,0) -- (13.25,6); 
	\draw [thick, red] (9.2,0) -- (13.7,6); 
	\draw [thick, red] (9.65,0) -- (14.15,6);
	\draw [thick, red] (10.1,0) -- (14.60,6);
	\draw [thick, red] (10.55,0) -- (15.05,6);
	\draw [thick, red] (11,0) -- (15.60,6);
	\draw [thick, red] (8.3,0) -- (12.8,6); 
	\draw [thick, red] (13.5,0) -- (11,6);
	\draw [thick, red] (12.87,0) -- (10.37,6);
	\draw [thick, red] (12.24,0) -- (9.74,6);
	\filldraw (4,4) circle (2pt) node[anchor = south east] {$ \mathbf{x} $};
	\filldraw (11.65,4.5) circle (2pt) node[anchor = south west] {$ \mathbf{f(x)} $};
	\draw[thick, ->,red] (6.4,2) to[out=-30,in=-150] (7.4,2);	
	\draw[red] (6.9,1.5) node {$ \mathbf{J(f)}$};
	\end{tikzpicture}
	\caption{derivative linear map.}
\end{figure}
\subsection{The Chain Rule}
